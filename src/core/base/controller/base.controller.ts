...
export class BaseController<M extends Model<any>> {
   ...
   * @return {Object}
   */
  async buildModelQueryObject(pagination: Paginate, queryParser: QueryParser = null) {
